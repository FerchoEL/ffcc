<div>
    ...
    @if($showModal1)
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    @foreach($railroadswitches as $railroadswitch)
                        ...
                        @endif
                        <div class="col-md-4 col-sm-6">
                            <div class="btn {{$condition}} btn-block mt-2" wire:click="openModal3({{$railroadswitch->id}},'switch')">
                                <div class="profile-id">
            ...
            <div class="card-footer" style="display: flex; justify-content: flex-end;">
                <button type="button" class="btn btn-info" data-dismiss="modal" x-on:click="$wire.closeModal1()"><i class='fas fa-reply'></i> Regresar</button>
            </div>
        </div>
    @endif
    @if($showModal2)
        <div class="card">
                    ...
                    @foreach($tracksections as $tracksection)
                        <div class="col-lg-4 col-sm-6">
                            ...
                            @else
                                ...
                                @endphp
                            @endif
                            <div class="btn {{$condition}} btn-block mt-2" wire:click="openModal3({{$tracksection->id}},'tramo')">
                                    <div class="profile-id">
            ...
            <div class="card-footer" style="display: flex; justify-content: flex-end;">
                <button type="button" class="btn btn-info" data-dismiss="modal" x-on:click="$wire.closeModal2()"> <i class='fas fa-reply'></i> Regresar</button>
            </div>
        </div>
    @endif
    @if($showModal3)
        <div class="card">
            ...
            <div class="card-footer" style="display: flex; justify-content: flex-end;">
                <button type="button" class="btn btn-info" data-dismiss="modal" x-on:click="$wire.closeModal3()"><i class='fas fa-reply'></i> Regresar</button>
            </div>
        </div>
    @endif
    @if($showModal4)
        <div class="card">
            ...
            <div class="card-footer" style="display: flex; justify-content: flex-end;">
                <button type="button" class="btn btn-info" data-dismiss="modal" x-on:click="$wire.closeModal4()"><i class='fas fa-reply'></i> Regresar</button>
            </div>
        </div>
    @endif
    ...
    <style>
        ...
        @media (min-width: 992px) {
            .img-max-600 {
                max-width: 600px; /* Tamaño máximo de 600px en pantallas grandes */
            }
        }
